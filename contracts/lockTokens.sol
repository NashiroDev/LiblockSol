...
/**
* TokenTimelock contract from OpenZeppelin, overwrited to match Liblock stacking requirements 
*/
contract TokenTimelock {
     ...
     * (in seconds).
     */
    constructor(IERC20 token_, address beneficiary_, uint256 releaseTime_, address admin_) {
    ...
    function release() external {
        require(msg.sender == _admin, "Not stacking contract");
